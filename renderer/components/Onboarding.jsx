      ...
      <div className="max-w-md w-full">
        ...
        {currentStep === 'welcome' && (
          <div className="text-center space-y-4">
            ...
            <p className="text-gray-400">
              System-wide voice dictation for macOS. Press a hotkey from any app, speak, and clean text gets pasted at your cursor.
            </p>
            <button
              onClick={next}
        ...
        {currentStep === 'test' && (
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-400">
              Press <kbd className="bg-white/10 px-2 py-0.5 rounded text-white text-xs">Cmd+Shift+Space</kbd> to start recording, speak something, then press again to stop.
            </p>
        ...
        {currentStep === 'done' && (
          <div className="text-center space-y-4">
            ...
            <p className="text-gray-400 text-sm">
              AbhiFlow is running in your menu bar. Press <kbd className="bg-white/10 px-2 py-0.5 rounded text-white text-xs">Cmd+Shift+Space</kbd> from any app to start dictating.
            </p>
            <button
              onClick={onComplete}
              className="w-full py-3 bg-abhiflow-500 text-white rounded-xl font-medium hover:bg-abhiflow-600"
